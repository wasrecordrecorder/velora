...
public final class CompiledModule {
    ...
    public CompiledFunction function(int index) { return index >= 0 && index < functions.size() ? functions.get(index) : null; }
    public CompiledFunction functionByName(String name) { return functionsByName.get(name); }
